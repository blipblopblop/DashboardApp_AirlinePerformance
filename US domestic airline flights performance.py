...
app.layout = html.Div(children=[ 
                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        placeholder='Select a report type', style={'textAlign': 'center', 'width': '80%', 'padding': '3px', 'font-size': '20px'})
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            # Enter your code below. Make sure you have correct formatting.
            line_fig = px.line(line_data, x = 'Month', y = 'AirTime', color = 'Reporting_Airline', title = 'monthly flight time (minutes) by airline')
